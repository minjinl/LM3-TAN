...
!Balaji
  ...
  real               :: sinuosity = 1.3
  real               :: rt_min_rate_per_day = 0.6
  real               :: rt_nit_rate_per_day = 0.6
  real               :: rt_denit_rate_per_day = 0.05
  ...
  namelist /river_nml/ dt_slow, diag_freq, debug_river, do_age,              &
                       ...
                       rt_min_rate_per_day, rt_nit_rate_per_day, rt_denit_rate_per_day,      &
...
!--- read the data from the file river_src_file -- has all static river network data
    ...
    River%min_rate   = rt_min_rate_per_day  / 86400
    River%nit_rate   = rt_nit_rate_per_day  / 86400
    River%denit_rate   = rt_denit_rate_per_day/ 86400
...
!--- release memory
    ...
    !deallocate(River%min_rate,River%nit_rate,River%denit_rate)
...
!!$    end do
   ...
   ! allocate(River%min_rate,River%nit_rate,River%denit_rate)
